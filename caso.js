...
(function(window){
    ...
    Player.prototype.draw = function(){
        ...
        Game.ctx.font = "bold 27px Lato, sans-serif";
        Game.ctx.fillText("Testigo", this.x, this.y+20, this.width, this.height);
    };
    ...
    Enemy.prototype.draw = function(){
        ...
        Game.ctx.fillRect(this.x, this.y, this.width, this.height);
        Game.ctx.fillStyle = "black";
        Game.ctx.font = "bold 30px Lato, sans-serif";
        Game.ctx.fillText("Ateo", this.x, this.y+20, this.width, this.height);
    };
